...
<br/>• **Обновить сервисные данные** <br/>Создаёт новый U-Config с изменёнными сервисными данными и перезаписывает текущий.

<br/>• **KeenBOOT OTA Update** <br/>Онлайн обновление/даунгрейд загрузчика.
:::
