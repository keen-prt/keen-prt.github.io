...
::: danger
Вес полного бэкапа устройства должен быть равен **128 МБ (134 217 728 байт)**
:::
::: tip 
Если после восстановления роутер загрузился в Breed - выполните установку родного загрузчика от вашей модели (см. пункт 7 ниже).
