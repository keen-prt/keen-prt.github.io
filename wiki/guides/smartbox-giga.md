# SmartBox Giga <BoostyBadge type="keenetic" text="5.1.5"/> <OTABadge type="keenetic" text="5.1.4 (OTA)"/> <YezBadge type="keenetic" text="5.1.1" url="/assets/files/firmware/SmartBox-Giga.7z"/>
...
4. **Извлечение EEPROM.** В [инструменте «Извлечь EEPROM»](/wiki/helpful/tools#cutter) загрузите `Full.bin` из предыдущего шага и скачайте извлечённый EEPROM.
5. **Подготовка EEPROM.** Откройте [инструмент «Внести MAC»](/wiki/helpful/tools#converter), загрузите EEPROM из предыдущего шага и укажите MAC-адрес с наклейки. Скачайте созданный `eeprom.bin`.
