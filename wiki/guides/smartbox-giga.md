# SmartBox Giga <YezBadgeWithDropdown type="keenetic" text="4.2.1" url="/assets/files/firmware/SmartBox-Giga-4.2.1.7z" :versions="[{ text: '4.1.7', url: '/assets/files/firmware/SmartBox-Giga-4.1.7.7z' }]"/>
