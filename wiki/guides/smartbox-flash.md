...
![альтернативный текст](/public/assets/images/wiki/guides/SmartBox/flash.png)
...
альтернативой.
:::
![альтернативный текст](/public/assets/images/wiki/helpful/usb-mod/flash-1.jpg){width=300px height=100px}

![альтернативный текст](/public/assets/images/wiki/helpful/usb-mod/flash-2.jpg){width=300px height=100px}

![альтернативный текст](/public/assets/images/wiki/helpful/usb-mod/flash-3.jpg){width=300px height=100px}
