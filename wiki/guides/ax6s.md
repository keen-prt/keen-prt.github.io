...
5. После перезагрузки роутера и восстановления проводного подключения (**Ethernet**) запустите файл `Redmi_AX6S_flasher.exe`, нажмите установить и дождитесь завершения скрипта.
