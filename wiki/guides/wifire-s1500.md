...
![WiFire S1500.NBN](/assets/images/wiki/guides/SmartBox/s1500.png)
...
1. **Установка пакета.** В установленной OpenWrt подключите роутер к интернету и установите пакет `kmod-mtd-rw`.
2. **Сохранение калибровок.** Сохраните из LuCI (вкладка `System - Backup / Flash firmware`) раздел `factory`.
3. **Подготовка EEPROM.** В [инструменте «Внести MAC»](/wiki/helpful/tools#converter) загрузите полученный файл и укажите MAC-адрес с наклейки. Добавьте созданный `eeprom.bin` в папку с прошивкой.
