# Xiaomi Router 4 <BoostyBadge type="keenetic" text="5.2"/><OTABadge type="keenetic" text="5.1.4 (OTA)"/> <YezBadge type="keenetic" text="5.0.12" url="/assets/files/firmware/Xiaomi-4.7z"/>
...
1. **Раздача файлов.** Запустите `!HFS.exe` и перетащите в его окно все `.bin`-файлы из папки с прошивкой: `U-Config`, `U-State`, `EEPROM` и `Xiaomi4_xxx`.
