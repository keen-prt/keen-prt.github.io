# Xiaomi Router 4 <OTABadge type="keenetic" text="5.1.4 (OTA)"/> <YezBadge type="keenetic" text="5.0.12" url="/assets/files/firmware/Xiaomi-4.7z"/>
...
![Xiaomi Router 4](/assets/images/wiki/guides/Xiaomi/xiaomi4.jpg)
...
1. **Раздача файлов.** В папке с прошивкой перетащите все `bin`-файлы (`U-Config`, `U-State`, `EEPROM`, `Xiaomi4_xxx`) на `!HFS.exe`.
