...
5. Запускаем Putty, заходим по TelNet (192.168.1.1 port 23) и дальнейшие команды вставляем(ПКМ) поочередно, ожидая
   ...
   :::
   ::: tip ИНФОРМАЦИЯ
   **• При возникновении проблем с прошивкой можно воспользоваться удалённой установкой через AnyDesk на Windows 10/11, стоимость – `400₽`. Отправить EEPROM_XXX.bin [@spatiumstas](https://t.me/spatiumstas)**<br/>
