# Xiaomi Mi Router 3G v1 <YezBadge type="keenetic" text="4.2.2" url="/assets/files/firmware/Xiaomi-3Gv1-4.2.2.7z" />
...
## Обновление прошивки
::: tip • Если у вас уже был установлен Keenetic не нашей модификации, пожалуйста, выполните установку начисто с 3 шага в блоке [Установка](/wiki/guides/xiaomi-3Gv1#установка)
**• Восстановление из предыдущего файла конфигурации не рекомендуется!**
:::
