# Xiaomi Router 3G <BoostyBadge type="keenetic" text="5.1.2"/> <OTABadge type="keenetic" text="5.1.1 (OTA)"/> <YezBadge type="keenetic" text="5.1.1" url="/assets/files/firmware/Xiaomi-R3G.7z"/>
...
4. **Вход в Breed.** Перейдите в загрузчик Breed ([как?](/wiki/helpful/breedBootloader#как-заити-в-загрузчик-breed)) по адресу `192.168.1.1`.
