...
4. Перейдите в загрузчик Breed ([`как?`](/wiki/helpful/breedBootloader#как-заити-в-загрузчик-breed)) по адресу 192.168.1.1. Убедитесь что установлена версия `1.2 (ZM.04)`, в противном случае обновите его ([`как?`](/wiki/helpful/breedBootloader#как-обновить-загрузчик)) выбрав файл `Keenetic/Breed.bin`
...
::: danger ВНИМАНИЕ
   ...
   **192.168.1.xxx**
   <br/>• Вместо **firmware.bin** в команде ниже, нужно указывать название прошивки, например `wget http://192.168.1.2/Xiaomi-R3G_4.2.3.bin`
:::
