...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: "Используемые на данном сайте товарные знаки, логотипы и другие объекты интеллектуальной собственности принадлежат компании Keenetic и ее партнерам. Все права защищены.",
