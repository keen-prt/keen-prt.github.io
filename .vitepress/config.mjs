...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: "Используемые на данном сайте товарные знаки, логотипы и другие объекты интеллектуальной собственности принадлежат компании Keenetic и ее партнерам.<br>keen_prt не владеет никакими правами на указанные объекты, и вся информация на сайте представлена исключительно для личного пользования в ознакомительных целях. Все права защищены.",
      copyright: "© 2024 keen_prt",
    },
    docFooter: {
      prev: false,
      next: false,
